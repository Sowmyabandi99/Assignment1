...
\begin{lstlisting}
https://github.com/Sowmyabandi99/Assignment.1/blob/main/Assignment1.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/Sowmyabandi99/Assignment.1/blob/main/main.tex
\end{lstlisting}
%
...
\\
c^2 - b^2 + a^2 - 2ac CosB = 0
\\
(c+b)(c-b) + 8^2 - 2(8)(\frac{1}{\sqrt{2}})c = 0 \quad \brak{\because \angle B = 45^{\degree}}
\\
3.5(c+b) + 64 - 11.31c = 0 \quad \brak{\because c-b = 3.5}
\\
\implies 7.81c - 3.5b = 64
\end{align}
